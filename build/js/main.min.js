...
/*!*****************************!*\
  !*** ./js/footer-button.js ***!
  \*****************************/
/*! exports provided: sectionsButton, adressButton, onClickSectionsButton, onClickAdressButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sectionsButton", function() { return sectionsButton; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "adressButton", function() { return adressButton; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onClickSectionsButton", function() { return onClickSectionsButton; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onClickAdressButton", function() { return onClickAdressButton; });
var sectionsButton = document.querySelector('.footer__sections-button');
var adressButton = document.querySelector('.footer__adress-button');
var sectionsList = document.querySelector('.footer__sections-list');
var adressList = document.querySelector('.footer__adress-list');
var sectionsButtonOriginalText = sectionsButton.textContent;
var adressButtonOriginalText = adressButton.textContent;
var onClickSectionsButton = function onClickSectionsButton() {
  sectionsList.classList.toggle('footer__sections-list--show');
  sectionsButton.textContent = sectionsButton.textContent === sectionsButtonOriginalText ? '-' : sectionsButtonOriginalText;
};
var onClickAdressButton = function onClickAdressButton() {
  adressList.classList.toggle('footer__adress-list--show');
  adressButton.textContent = adressButton.textContent === adressButtonOriginalText ? '-' : adressButtonOriginalText;
};
...
/* harmony import */ var _footer_button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./footer-button */ "./js/footer-button.js");
...
_footer_button__WEBPACK_IMPORTED_MODULE_3__["adressButton"].addEventListener('click', _footer_button__WEBPACK_IMPORTED_MODULE_3__["onClickAdressButton"]);
_footer_button__WEBPACK_IMPORTED_MODULE_3__["sectionsButton"].addEventListener('click', _footer_button__WEBPACK_IMPORTED_MODULE_3__["onClickSectionsButton"]);
_more__WEBPACK_IMPORTED_MODULE_4__["moreButton"].addEventListener('click', _more__WEBPACK_IMPORTED_MODULE_4__["onClickMoreButton"]);
...
/*!********************!*\
  !*** ./js/more.js ***!
  \********************/
/*! exports provided: moreButton, onClickMoreButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "moreButton", function() { return moreButton; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onClickMoreButton", function() { return onClickMoreButton; });
var moreButton = document.querySelector('.about__button');
var extraDescription = document.querySelector('.about__description--hidden');
var originalTextContent = moreButton.textContent;
var onClickMoreButton = function onClickMoreButton() {
  extraDescription.classList.toggle('about__description--show');
  moreButton.textContent = moreButton.textContent === originalTextContent ? 'Скрыть' : originalTextContent;
};
